        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p style="color:orange">Please fill this form to create an account.</p>
                    <!-- <?php echo $success; ?>
                    <?php echo $error; ?> -->
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label style="color:orange">Phone Num.</label>
                        ...
                        <p style="color:pink">Already have an account? <a href="index.php" style="color: red;">Login here</a>.</p>
                    </form>
                </div>
            </div>
            <hr><p style="color:red">Notice: If the email Id is registered before, it will not respond.</p>
            <p style="color:red">In this case, reset your password or register with different email Id....</p>
        </div>    
    </body>
</html>