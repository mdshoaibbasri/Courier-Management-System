...
<div class="admintitle">
    ...
    <h1 align='center' style="text-shadow: 0.1em 0.1em 0.15em #f9829b; color:#f95d9b">Showing All Users</h1>
</div>
<div style="overflow-x:auto;">
<table width='50%' border="1px solid" style="margin-left: auto; margin-right:700px; margin-top:30px; font-weight:bold;border-collapse: collapse;">
