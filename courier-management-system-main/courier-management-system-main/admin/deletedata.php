...
<div class="admintitle">
    ...
    <h1 align='center' style="text-shadow: 0.1em 0.1em 0.15em #f9829b; color:#f95d9b">Search Data Information</h1>
</div>

<div style="overflow-x:auto;">
<table width='50%' border="1px solid" style="margin-left:70px; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 5px 5px;">
    <tr style="background-color:#DCC7AA;">
        <th>No.</th>
        <th>Items Image</th>
        <th>Sender Name</th>
        <th>Receiver Name</th>
    ...
    if(mysqli_num_rows($run)<1){
        ...
        while($data=mysqli_fetch_assoc($run))
        {
            $count++;
        ?>
        <tr align="center" style="background-color:#e1b382">
